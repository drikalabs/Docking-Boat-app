...
public class MessageConstant {
    public static final String CREATED_PIER_SLOT="Created a boating dock with %d piers";
    ...
    public static final String SUCCESS_RESERVE="Reserved pier number : %d";
    public static final String FAIL_RESERVE="Cannot Reserve pier because already used";
    ...
    public static final String STATUS_BODY   ="%d        %s      %s\n";
}
